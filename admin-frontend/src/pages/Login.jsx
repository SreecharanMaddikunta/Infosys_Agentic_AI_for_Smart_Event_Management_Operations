...
export default function Login({ setIsAuthenticated }) {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if(res.data.user.role !== 'ADMIN' && res.data.user.role !== 'SUPERADMIN') {
                setError(`Access Denied. You are a ${res.data.user.role}. Please log into the correct portal.`);
                return;
            }
    ...
    return (
        <div className="flex justify-center items-center min-h-[70vh]">
            ...
            >
                <h2 className="text-3xl font-bold mb-2 text-center capitalize">Admin Login</h2>
                <p className="text-center text-muted-foreground mb-6">Secure Organizer Access</p>
